...
from infrastructure.databases import get_db
...
# Tạo lịch tư vấn (Consultant tạo lịch rảnh)
@router.post("/schedule", response_model=schemas.ConsultantScheduleOut)
def create_schedule(
    schedule: schemas.ConsultantScheduleCreate,
...
def book_appointment(
    ...
    # Kiểm tra nếu lịch đã có người đặt
    existing_appointment = db.query(models.Appointment).filter_by(schedule_id=schedule.id).first()
